...
SECRET_KEY = 'django-insecure-eso*@lw&jm(_=qbsj&zk*&_bhf&@3qgkvol8qa1^6ez2j3kq_0'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=5), # Tu deseo de 5 minutos
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
DEFAULT_FROM_EMAIL = 'notificaciones@tu-fintech.com'
